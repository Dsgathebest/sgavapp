<?php
    ...
    class LivingPlace{
        ...
        protected static $columnsTbl=['id_living','id_person','id_city','rooms_living','bathrooms_living','kitchen_living','tvrooms_living','yard_living','pool_living','barbecue_living','image_living','id_typehouse'];
        private $id_living;
        private $id_person;
        private $id_city;
        ...
        public function __construct($args = []){
            ...
            $this->tvrooms_living = $args['tvrooms_living'] ?? '';
            $this->yard_living = $args['yard_living'] ?? '';
        ...
        public function loadAllData(){
            $sql = "SELECT id_living,id_person,id_city, rooms_living, bathrooms_living, kitchen_living, yard_living, pool_living, barbecue_living, image_living, id_typehouse FROM living_place";
            $stmt= self::$conn->prepare($sql);
            $stmt->execute();
        ...
        public function loadByIdData($id){
            $sql = "SELECT id_living,id_person,id_city, birthdate_person, bathrooms_living, kitchen_living, yard_living, pool_living, barbecue_living, image_living, id_typehouse FROM living_place WHERE id_living = :id_living";
            $stmt= self::$conn->prepare($sql);
